...
const TRAMITES = [
    // 1. Permiso de quema de horno ladrillera
    {
        ...
        descripcion: "Permiso para realizar quema controlada en horno ladrillero.",
        categoria: "PERMISO",
        orden: 1,
        precioBase: 250,
        campos: [
    ...
    // 3. Permiso de derribo de árbol
    {
        ...
        campos: [
            ...
            },
            {
                ...
                helpText: "Define la tarifa (I, II o III) y el factor de forma sugerido",
                showInAuthorization: true,
                afectaPrecio: true,
            },
            {
 ...
 */
export async function runSeed(log = true) {
    ...
    for (const t of TRAMITES) {
        await prisma.tramite.upsert({
            ...
            create: {
                ...
                reglaPrecio: t.reglaPrecio ?? undefined,
