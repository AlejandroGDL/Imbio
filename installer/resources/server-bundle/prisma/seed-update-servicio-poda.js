/**
 * Script one-off para actualizar los `campos` del trámite SERVICIO_PODA
...
async function main() {
    const result = await prisma.tramite.updateMany({
        where: { codigo: "SERVICIO_PODA" },
        data: { campos: NUEVOS_CAMPOS },
    });
    console.log(`✓ Actualizado SERVICIO_PODA (${result.count} fila(s))`);
...
//# sourceMappingURL=seed-update-servicio-poda.js.map