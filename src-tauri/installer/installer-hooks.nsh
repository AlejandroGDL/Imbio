...
; =================================================================
; PREINSTALL: 2 MessageBox YESNO (funciona, YESNOCANCEL no)
; POSTINSTALL: ejecutar PowerShell install.ps1 que configura todo
; =================================================================
...
; -----------------------------------------------------------------
; PREINSTALL - Seleccion de modo (Servidor o Cliente)
; -----------------------------------------------------------------
...
; -----------------------------------------------------------------
; POSTINSTALL - Ejecutar PowerShell install.ps1
; -----------------------------------------------------------------
!macro NSIS_HOOK_POSTINSTALL
    ...
    IfFileExists "$0" 0 imbio_post_done
    ...
    ; vea el progreso (descarga de binarios puede tardar)
